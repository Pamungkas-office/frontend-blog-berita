...
import { Globe, ExternalLink, Calendar, Eye } from 'lucide-react'
...
export function ApprovalQueuePage() {
  ...
  const handlePublish = async (postId: string) => {
    if (!confirm('Yakin ingin mempublikasikan post ini?')) return
    setActionLoading(postId)
    try {
      await superAdminApprovalService.publish(postId)
      fetchQueue()
    } finally {
